...
public class KnightStats_ : MonoBehaviour
{
    public ScrObjEnemyStats knightStats;
    ...
    public void Awake()
    {
        ...
        knightStats.hp = knightStats.maxHp;
        knightHp = knightStats.hp;
        ...
        _transformHpLine.localScale = new Vector3(knightHp / knightStats.maxHp, 0.1f, 0.01f);
    ...
    public void Attacked(float heroDamage)
    {
        ...
        _transformHpLine.localScale = new Vector3(knightHp / knightStats.maxHp, 0.25f, 0.01f);
    }
